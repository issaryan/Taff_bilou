  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-start justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-5xl space-y-8">
        <div>
          <h2 className="text-3xl font-bold text-gray-900 text-center">Ajouter un nouveau client</h2>
          <p className="mt-2 text-center text-sm text-gray-600">
            Remplissez les informations ci-dessous pour enregistrer un nouveau client.
          </p>
        </div>
