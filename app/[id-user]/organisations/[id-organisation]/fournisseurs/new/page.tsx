  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-start justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-5xl space-y-8">
        <div>
          <h2 className="text-3xl font-bold text-gray-900 text-center">Ajouter un nouveau fournisseur</h2>
          <p className="mt-2 text-center text-sm text-gray-600">
            Remplissez les informations ci-dessous pour enregistrer un nouveau fournisseur.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="col-span-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <InputField label="mode de paiement" name="modePaiement" value={formData.modePaiement} onChange={handleChange} />
                <InputField label="delai livraison" name="delaiLivraison" value={formData.delaiLivraison} onChange={handleChange} />
                <InputField label="Contrat cadre" name="Segment" value={formData.contratCadre} onChange={handleChange} />
                <InputField label="Zone Livraison" name="Segment" value={formData.zoneLivraison} onChange={handleChange} />
                <InputField label="Certification" name="Segment" value={formData.certification} onChange={handleChange} />
                <InputField label="produits Principaux" name="Segment" value={formData.produitsPrincipaux} onChange={handleChange} />
              </div>
            </div>
