  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-start justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-5xl space-y-8">
        <div>
          <h2 className="text-3xl font-bold text-gray-900 text-center">Ajouter un nouveau commercial</h2>
          <p className="mt-2 text-center text-sm text-gray-600">
            Remplissez les informations ci-dessous pour enregistrer un nouveau commercial.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="col-span-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <InputField label="Canal d'acquisition" name="canalAcquisition" value={formData.canalAcquisition} onChange={handleChange} />
                <InputField label="Plafond de crédit" name="plafondCredit" value={formData.plafondCredit} onChange={handleChange} />
                <InputField label="Segment" name="Segment" value={formData.Segment} onChange={handleChange} />
                <InputField label='identifiant RH' name="identifiantRh" value={formData.identifiantRh} onChange={handleChange}/>
                <InputField label='Zone de Couverture' name='zoneCouverture' value={formData.zoneCouverture} onChange={handleChange}/>
                <InputField label='Nombre de clients gérés' name='nombreClientsGeres' value={formData.nombreClientsGeres} onChange={handleChange}/>
